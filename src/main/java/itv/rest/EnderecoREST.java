 ...
 **/
@RestController
@RequestMapping(value = "/api/rest/itv/Endereco")
public class EnderecoREST {
  ...
  public Endereco put(@Validated @RequestBody final Endereco entity, @PathVariable("enderecoId") java.lang.Integer enderecoId) throws Exception {
    return enderecoBusiness.put(entity);
  }  
  ...
  public void delete(@PathVariable("enderecoId") java.lang.Integer enderecoId) throws Exception {
  ...
  public Endereco get(@PathVariable("enderecoId") java.lang.Integer enderecoId) throws Exception {
